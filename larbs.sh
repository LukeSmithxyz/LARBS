...
Section "Screen"
    ...
    Option         "metamodes" "DP-0: 1920x1080_240 +1680+0 {AllowGSYNCCompatible=On}, HDMI-0: nvidia-auto-select +0+0"
    Option         "SLI" "Off"
    Option         "MultiGPU" "Off"
...
[ ! -f /etc/X11/xorg.conf ] && printf 'Section "InputClass"
