...
It is controlled by the keyboard and only shows the progress bar and other interfaces when needed.
...
- <kbd>h</kbd>/<kbd>l</kbd> -- jump back/forward 10 seconds.
- <kbd>j</kbd>/<kbd>k</kbd> -- jump back/forward 60 seconds.
...
- The LARBS binding <kbd>super + shift + P</kbd> will not only pause your music playing in `mpd`, but also all audio/video instances of `mpv`.
