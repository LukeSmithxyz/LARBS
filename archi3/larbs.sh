...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/jimbarrett/arch-configs.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/jimbarrett/LARBS/master/archi3/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "This is my fork of LARBS by Luke Smith. This is tailored for my specific needs and may or may not work for you. Use with caution." 10 60
	}
